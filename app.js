 ...
 * Fixed for Rotors, Tools, and Blast Properties
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateCode() {
        ...
        // 5. Rotors (Fixed with float notation)
        ...
        // 7. Tools (Fixed multi-select and builder)
